...
```
export SONAR_TOKEN=squ_07ab1df20e90f73fd5ede4fb35c8aee5b8efdb13
#sonar_token set in env like below

export SONAR_TOKEN=squ_[lotsofnumbers]

mvn clean verify sonar:sonar -Dsonar.host.url=https://automatic-telegram-r76x5797r7gf5qxp-9000.app.github.dev -Dsonar.coverage.exclusions=**/*
```
